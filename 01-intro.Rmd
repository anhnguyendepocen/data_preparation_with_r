...
* bought a cup of coffee (which generates at least three types of information: the drink itself, about your coffee habits from the rewards program, and the financial transaction); 

* travelled to your place of work or study, measured by the movement of your cell phone; 

* reserved a book at the library, and
...
The process of going from data to decision support is often called data science. It combines the academic disciplines of statistics, computer programming, and the subject matter (be it astronomy, psychology, economics, or business). The typical data science process has been described in this model [@Wickham_Grolemund2016]:
