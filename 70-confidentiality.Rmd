...
# Anonymity and Confidentiality {#anonymity}
...
Many of the practical applications of statistical disclosure control can be traced back to the work of various statistical agencies around the world, who are confronted with the challenge of balancing increased expectations for openness and transparency (which translates into an increasing demand for the release of data) with "an increasing public consciousness about the privacy of individuals" ([@Bethlehem_2009], p.342). 
...
* "Sorry, your data can still be identified even if it’s anonymized" [@CampbellDollaghan_2018]
...
The Canadian Panel on Research Ethics had created a policy document that includes a chapter on Privacy and Confidentiality [@Panel_on_Research_Ethics_TCPS2_2018], covering the full range of concerns about the use of individual data.
...
* "What is the difference between the terms coded, de-identified, and anonymous?" [@OS_Office_of_Research]

* Justin Brickell and Vitaly Shmatikov, "The Cost of Privacy: Destruction of Data-Mining Utility in Anonymized Data Publishing"[@Brickell_Shmatikov_2008]
...
Li, Xiao-Bai and Qin, Jialun, "Anonymizing and Sharing Medical Text Records" [@doi:10.1287/isre.2016.0676]
...
Statistics Canada, _Generic Privacy Impact Assessment for Statistics Canada's Statistical Programs_, Glossary of Terms [@StatCan_privacy_glossary]
...
Jelke Bethlehem, 2009: [_Applied Survey Methods: A Statistical Perspective_](http://ca.wiley.com/WileyCDA/WileyTitle/productCd-0470373083.html), Wiley (Wiley Series in Survey Methodology) [@Bethlehem_2009]
...
Anco Hundepool, Josep Domingo-Ferrer, Luisa Franconi, Sarah Giessing, Eric Schulte Nordholt, Keith Spicer, Peter-Paul de Wolf, 2012: [_Statistical Disclosure Control_](http://ca.wiley.com/WileyCDA/WileyTitle/productCd-1119978157.html), Wiley (Wiley Series in Survey Methodology) [@Hundepool_etal_2012]
...
{sdcMicro} [@R-sdcMicro] is the best available SDC tool I have found in the R space, so I've given it top-billing rather than my usual alpabetical listing.
...
GitHub page: [Anonymizes data containing Personally Identifiable Information (PII) using a combination of salting and hashing.](https://github.com/wilkox/deidentifyr) [@R-anonymizer]
...
GitHub page: [An R package for deidentifying datasets that may contain personally identifiable information (PII)](https://github.com/wilkox/deidentifyr) [@R-deidentifyr]
