...
If you're working in the area of social and economic research, the national and international statistics agencies provide robust and in-depth classification systems, much of which is designed to allow for international comparisons.
...
A part of classification systems is _how things are named_. While a classification system will provide some guidance or explicit direction on how the things being measured should be categorized and named, there are often cases where we the analysts are responsible for naming things. There is significant benefit to being thoughtful about this process, as it extends beyond the naming of variables and how values are encoded. It extends to the names of the files you create and the names of the folders you organize them in.
