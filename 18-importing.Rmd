...
Plain-text (sometimes called "ASCII files", after . They are very commonly used for storing data files. They don't have any formatting—just the number or text.
...
The {readr} [@R-readr] package is part of the tidyverse, and provides some streamlining of the functions noted above.
